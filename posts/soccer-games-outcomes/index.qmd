...
```{python}
gtp_cols = ['ht', 'at', 'ftr', 'hma10', 'ama10']
...
```{python}
gtp_all_res_cols = ['ht', 'at', 'fthg', 'ftag', 'ftr', 'hma10', 'ama10', 'pred_hgoals', 'pred_agoals', 'h_prob', 'a_prob', 'joint_prob']
games_to_predict_all_res[gtp_all_res_cols].dropna().sort_values(['ht', 'at', 'joint_prob'], ascending=False).head(50)
```
